...
- Fix bug with disabling time zone retrieval for broken firmware versions.
...
[Unreleased]: https://github.com/Nadahar/Mill-LAN-openHAB-Binding/compare/v1.0.3...HEAD
[1.0.3]: https://github.com/Nadahar/Mill-LAN-openHAB-Binding/releases/tag/v1.0.3
