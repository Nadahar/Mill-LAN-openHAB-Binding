...
import org.openhab.binding.milllan.internal.action.MillWiFiSocketActions;
...
/**
 * The Thing handler for the {@code Wi-Fi Socket} thing type.
 *
 * @author Nadahar - Initial contribution
 */
@NonNullByDefault
public class MillWiFiSocketHandler extends AbstractMillThingHandler {
    ...
    public Collection<Class<? extends ThingHandlerService>> getServices() {
        return Set.of(MillWiFiSocketActions.class);
    }
